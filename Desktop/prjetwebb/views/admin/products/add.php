...
<div class="admin-container">
    ...
    <div class="admin-form-container">
        <form method="POST"
            action="/bookshop/public/index.php?action=store&controller=admin_product"
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ref"
                            name="ref"
                            value="<?= htmlspecialchars($_SESSION['old_input']['ref'] ?? '') ?>"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="titre"
                            name="titre"
                            value="<?= htmlspecialchars($_SESSION['old_input']['titre'] ?? '') ?>"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descrip"
                            name="descrip"
                            rows="5"><?= htmlspecialchars($_SESSION['old_input']['descrip'] ?? '') ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01"
                                ...
                                value="<?= htmlspecialchars($_SESSION['old_input']['prix'] ?? '') ?>"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantite"
                            name="quantite"
                            value="<?= htmlspecialchars($_SESSION['old_input']['quantite'] ?? '0') ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="etat" name="etat">
                            <option value="stock"
                                <?= ($_SESSION['old_input']['etat'] ?? '') === 'stock' ? 'selected' : '' ?>>En stock
                            </option>
                            <option value="rupture"
                                <?= ($_SESSION['old_input']['etat'] ?? '') === 'rupture' ? 'selected' : '' ?>>En rupture
                            </option>
                            <option value="commande"
                                <?= ($_SESSION['old_input']['etat'] ?? '') === 'commande' ? 'selected' : '' ?>>Sur
                                commande</option>
                        </select>
                    </div>
                        ...
                        <select class="form-control" id="id_cat" name="id_cat">
                            ...
                            <?php foreach ($categories as $category): ?>
                                <option value="<?= $category['id_cat'] ?>"
                                    <?= ($_SESSION['old_input']['id_cat'] ?? '') == $category['id_cat'] ? 'selected' : '' ?>>
